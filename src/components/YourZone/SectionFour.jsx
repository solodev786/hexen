            ...
            <div className=" md:w-1/2 pr-5 pb-10 md:border-r border-gray-600 ">
              <div className=" flex flex-col gap-5">
                ...
                <h1>
                  ...
                  to ensure security and functionality. Regular updates protect
                  your site from vulnerabilities and enhance performance.
                </h1>
              </div>
            </div>
            <div className=" md:w-1/2 pr-5 pb-10 md:border-r border-gray-600 ">
            ...
            <div className=" md:w-1/2 pr-5 pb-5  ">
              <div className=" w-2/2 pr-5 pb-10  ">
                <div className=" flex flex-col gap-5">
                  ...
                  <h1>
                    Regularly back up your website's data to prevent data loss.
                    Ensure that backups are stored securely and can be easily
          ...
          <div className=" md:flex gap-10 items-center  border-gray-600 ">
            <div className=" md:w-1/2 pr-5 pb-10 md:border-r border-gray-600 ">
              <div className=" flex flex-col gap-5 mt-5">
                ...
                <h1>
                  Use tools to monitor your website's performance, including
                  load times, uptime, and broken links. Address any issues
                  promptly to provide a seamless user experience.
                </h1>
              </div>
            </div>
            <div className=" md:w-1/2 pr-5 pb-10 md:border-r border-gray-600 ">
            ...
            <div className=" md:w-1/2 pr-5 pb-5  ">
              <div className=" w-2/2 pr-5 pb-10  mt-5">
                <div className=" flex flex-col gap-5">
                  ...
                  <h1>
                    Gather and analyze feedback from your website's users. This
                    can help you identify areas for improvement and make
