        ...
        <div className=" md:w-[1200px] h-auto">
          ...
          <div className=" flex flex-col gap-5  w-full ">
            ...
            <h1 className=" md:w-3/5 ">
              ...
              transforming your ideas into reality. With years of experience and
              a portfolio of successful projects, we have helped numerous
              companies grow and thrive in the digital world. At Hexen, we
              believe in making the impossible possible, ensuring that our
              clients are not just satisfied but delighted with the results. Our
              commitment to quality, creativity, and client satisfaction sets us
              apart, making us a trusted partner in your digital journey.
            </h1>
            ...
            <div className=" md:mt-32 flex flex-col  gap-10 ">
              <div className=" md:justify-between md:flex w-full">
                ...
                <h1 className=" md:text-3xl md:font-semibold  xl md:w-4/5  font-extralight">
